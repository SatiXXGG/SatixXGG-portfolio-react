...
function App() {
  return (
    <>
      ...
      <h2>Past work</h2>
      <p>
        I didnt work in a very big game right now but I am a very experienced in
        almost all things like UI Design, programming and sometimes building I
        like making new systems and learn new things like programming languages
        or new technologies
      </p>
      </div>
    </>
